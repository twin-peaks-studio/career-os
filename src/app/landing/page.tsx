...
export default function LandingPage() {
  ...
  return (
    <div className="landing-page min-h-screen bg-[#09090b] text-white">
      {/* ─── Nav ─────────────────────────────────────────────── */}
      ...
      <section className="relative overflow-hidden pt-32 pb-20 sm:pt-40 sm:pb-28">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute top-[-20%] left-1/2 h-[600px] w-[800px] -translate-x-1/2 rounded-full bg-purple-600/[0.08] blur-[120px]" />
          <div className="absolute top-[10%] left-1/4 h-[400px] w-[400px] rounded-full bg-indigo-600/[0.06] blur-[100px]" />
        </div>

        <div className="relative mx-auto max-w-4xl px-6 text-center">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-purple-500/20 bg-purple-500/[0.08] px-4 py-1.5 text-sm text-purple-300">
          ...
          <form onSubmit={handleSubmit} className="mx-auto flex max-w-md flex-col gap-3 sm:flex-row">
            <input
              ...
              className="flex-1 rounded-xl border border-white/10 bg-white/[0.05] px-5 py-3.5 text-white placeholder-white/30 outline-none transition-colors focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/30"
              required
            />
            <button
              type="submit"
              disabled={status === 'loading' || status === 'success'}
              className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-3.5 font-medium text-white transition-all hover:from-purple-500 hover:to-indigo-500 disabled:opacity-60"
            >
              {status === 'success' ? (
                <>
          ...
          {status === 'success' && (
            <p className="mt-3 text-sm text-purple-300">We&apos;ll be in touch soon.</p>
          )}
          <p className="mt-4 text-xs text-white/30">Free early access. No spam.</p>
        </div>
      </section>
      ...
      <section className="relative border-t border-white/[0.06] py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            <p className="mb-3 text-sm font-medium uppercase tracking-widest text-purple-400">The problem</p>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 transition-colors hover:border-white/[0.1] hover:bg-white/[0.03]"
              >
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-red-500/[0.1] text-red-400">
                  {pain.icon}
                </div>
                <h3 className="mb-2 text-lg font-semibold">{pain.title}</h3>
                <p className="text-sm leading-relaxed text-white/40">{pain.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative border-t border-white/[0.06] py-20 sm:py-28">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute bottom-0 right-1/4 h-[400px] w-[600px] rounded-full bg-purple-600/[0.05] blur-[120px]" />
        </div>

        <div className="relative mx-auto max-w-6xl px-6">
          <div className="mb-16 text-center">
            <p className="mb-3 text-sm font-medium uppercase tracking-widest text-purple-400">The solution</p>
            <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={i}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 transition-colors hover:border-purple-500/20 hover:bg-white/[0.03]"
              >
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl bg-purple-500/[0.1] text-purple-400">
                  {benefit.icon}
                </div>
                <h3 className="mb-2 text-lg font-semibold">{benefit.title}</h3>
                <p className="text-sm leading-relaxed text-white/40">{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative border-t border-white/[0.06] py-20 sm:py-28">
        <div className="mx-auto max-w-4xl px-6">
          <div className="mb-16 text-center">
            <p className="mb-3 text-sm font-medium uppercase tracking-widest text-purple-400">How it works</p>
            <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            {[
              ...
              <div key={i} className="flex gap-6">
                <div className="flex flex-col items-center">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl border border-purple-500/20 bg-purple-500/[0.08] font-mono text-sm font-bold text-purple-400">
                    {item.step}
                  </div>
                  {i < 2 && (
                    <div className="mt-3 h-full w-px bg-gradient-to-b from-purple-500/20 to-transparent" />
                  )}
                </div>
                <div className="pb-2">
                  <h3 className="mb-2 text-xl font-semibold">{item.title}</h3>
                  <p className="mb-2 leading-relaxed text-white/50">{item.description}</p>
      ...
      <section className="relative border-t border-white/[0.06] py-20 sm:py-28">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute top-1/2 left-1/2 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-purple-600/[0.08] blur-[120px]" />
        </div>
      ...
      <footer className="border-t border-white/[0.06] py-8">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm text-white/40">Career OS</span>
          </div>
          <p className="text-sm text-white/20">&copy; {new Date().getFullYear()} Career OS</p>
        </div>
      </footer>
    </div>
  );
